...
namespace Agenda_de_contatos.AgendaDataSet1TableAdapters {
...
SELECT id_contato, nome, cpf, rg, data_de_nascimento, email, telefone1, telefone2, rua, numero, complemento, cep, cidade, estado, pais FROM Contato WHERE (id_contato = @id_contato)";
        ...
        public virtual int Fill(AgendaDataSet1.ContatoDataTable dataTable) {
        ...
        public virtual AgendaDataSet1.ContatoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            AgendaDataSet1.ContatoDataTable dataTable = new AgendaDataSet1.ContatoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(AgendaDataSet1.ContatoDataTable dataTable) {
